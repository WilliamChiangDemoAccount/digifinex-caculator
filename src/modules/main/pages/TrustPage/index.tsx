            ...
            <ul className='d-flex flex-column flex-sm-row mt-7 mt-sm-7_5 mt-lg-15 flex-wrap mx-auto align-items-stretch justify-content-center'>
                <li className='bg-white-1 border-radius-sm py-6 px-3 py-sm-5 px-sm-5 py-lg-10'>
                    <div className='d-flex flex-row align-items-center'>
                        ...
                        <h4 className='text-blue-2 fw-bold font-lg font-sm-xl font-lg-3xl'>{t('pages.trust.advance.advance-1.title')}</h4>
                    </div>
                ...
                <li className='bg-white-1 border-radius-sm mt-5 mt-sm-0 py-6 px-3 py-sm-5 px-sm-5 py-lg-10'>
                    <div className='d-flex flex-row align-items-center'>
                        ...
                        <h4 className='text-blue-2 fw-bold font-lg font-sm-xl font-lg-3xl'>{t('pages.trust.advance.advance-2.title')}</h4>
                    </div>
                ...
                <li className='bg-white-1 border-radius-sm mt-5 mt-lg-7_5 py-6 px-3 py-sm-5 px-sm-5 py-lg-10'>
                    <div className='d-flex flex-row align-items-center'>
                        ...
                        <h4 className='text-blue-2 fw-bold font-lg font-sm-xl font-lg-3xl'>{t('pages.trust.advance.advance-3.title')}</h4>
                    </div>
                ...
                <li className='bg-white-1 border-radius-sm mt-5 mt-lg-7_5 py-6 px-3 py-sm-5 px-sm-5 py-lg-10'>
                    <div className='d-flex flex-row align-items-center'>
                        ...
                        <h4 className='text-blue-2 fw-bold font-lg font-sm-xl font-lg-3xl'>{t('pages.trust.advance.advance-4.title')}</h4>
                    </div>
